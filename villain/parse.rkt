...
(define (parse-e s)
  (match s
    ...
    [(list (? (op? op3) p3) e1 e2 e3) (Prim3 p3 (parse-e e1) (parse-e e2) (parse-e e3))] ;; added
    [(list 'begin e1 e2)
...
(define op1
  '(add1 sub1 zero? char? write-byte eof-object?
         ...
         string-length string?))   ;; added
(define op2
  '(+ - eq? cons string-ref make-string))  ;; added
(define op3
  '(string-set!))  ;;added
